<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend/SiteFrontend.Master" AutoEventWireup="true" CodeBehind="YachtsFront.aspx.cs" Inherits="_20240702Yachts.Frontend.YachtsFront" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="bannermasks">
        <img src="./html/images/banner01_masks.png" alt="&quot;&quot;" />
    </div>
    <!--遮罩結束-->
...
<%--                        <li>
                            <a href="./html/images/test1.jpg">
                                <img src="./html/images/pit003.jpg">
                            </a>
                        </li>
                        <li>
                            <a href="./html/images/test002.jpg">
                                <img src="./html/images/pit003.jpg">
                            </a>
                        </li>
                        <li>
    ...
    <div class="conbg">
        ...
        <div class="left">
            ...
            <div class="left1">
                ...
                <ul>
                    ...
                    <%--左側邊欄遊艇型號選單使用 asp:Literal 控制項接收資料 --%>
        ...
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="./IndexFront">Home</a> >> <a href="#">Yachts</a> >>
            <%-- 加上 id="LabLink" runat="server" 這樣才可以更改對應的 型號名稱--%>
            <a href="./YachtsFront.aspx"><span class="on1" id="LabLink" runat="server">Dynasty 72</span></a>
        </div>

        <div class="right">
            <div class="right1">
                 <%-- 加上 id="LabTitle" runat="server" 這樣才可以更改對應的 型號名稱--%>
                <div class="title"><span id="LabTitle" runat="server">Dynasty 72</span></div>
                ...
                <div class="box3">
                    ...
                    <table class="table02">
                        <tr>
                            ...
                            <td>
                                <img src="./html/images/ya01.jpg" alt="&quot;&quot;" width="278" height="345" /></td>
                        </tr>
                    </table>
